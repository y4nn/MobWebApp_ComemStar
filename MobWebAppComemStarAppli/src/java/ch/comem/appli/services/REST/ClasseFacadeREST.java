 ...
 */
@Stateless
@Path("ch.comem.appli.model.classe")
public class ClasseFacadeREST extends AbstractFacade<Classe> {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<Classe> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
